        ...
        <aside id="sidebar" class="sidebar">
            ...
            <nav class="nav">
                ...
                <div style="display:flex;align-items:center;gap:6px">
                    <a href="/vehicle" class="{{ request()->is('vehicle') ? 'active' : '' }}" style="flex:1"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 13l1.5-4.5A2 2 0 016.4 7h11.2a2 2 0 011.9 1.5L21 13v5a1 1 0 01-1 1h-1a1 1 0 01-1-1v-1H6v1a1 1 0 01-1 1H4a1 1 0 01-1-1v-5zM6 14h12M7.5 10.5h9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg><span class="label">Vehicle</span></a>
